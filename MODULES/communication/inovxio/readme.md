...
*   **响应 (Response)**:
    *   **无直接响应**。
    *   但这会触发电机的状态更新。若已开启自动上报(CMD 24)，主机会持续收到状态反馈帧(CMD 2)。
...
*   **响应 (Response)**: 无。校准状态会在 Feedback 中体现 (Mode=1)。
